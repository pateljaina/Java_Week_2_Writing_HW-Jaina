...
public class Programme_15_SwapTheValue {
    ...
    public void swapTheValue(int a, int b) {
        int c;
        System.out.println(" Before swapping, The values of first variable is: " + a + " and second variable is:" + b);
        c = a;
        a = b;
        b = c;
        System.out.println("After the swapping, The values of first variables is : " + a + " and second variable is:  "
                + b);
    }
}